...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText.replace(/[^\w\s]/gi, '').trim().toLowerCase()) {
      ...
      case 'quote':
        requiresServerURL(sendQuoteMessage, [senderID]);
        break;
...
function sendHiMessage(recipientId) {
  var messageData = {
    ...
    message: {
      text: `
Right now, the bot can only respond to a few words. Try out "random chat", "funny",  "image" to see how they work.
      `
    }
  }
  ...
  var messageData = {
    ...
    message: {
      attachment: {
        type: "image",
        payload: {
          url: SERVER_URL + "/assets/uplifting.jpeg"
        }
      }
    }
  };
  ...
  var messageData = {
    ...
    message: {
      attachment: {
        type: "image",
        payload: {
          url: SERVER_URL + "/assets/funny.gif"
        }
      }
    }
  };
  ...
  var messageData = {
    ...
    message: {
      attachment: {
        type: "audio",
        payload: {
          url: SERVER_URL + "/assets/somethingElse.m4a"
        }
      }
    }
  };
...
function sendQuickReply(recipientId) {
  ...
  if (messageData.message.quick_replies.title === "Neutral") {
